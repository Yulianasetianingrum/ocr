 ...
 */
if (typeof window !== 'undefined' && !window.MicrosecondLogger) {
  /**
 * High-Precision Telemetry & Latency Logger
...
class MicrosecondLogger {
  ...
  window.MicrosecondLogger = MicrosecondLogger;
}
if (typeof module !== 'undefined') module.exports = { MicrosecondLogger: typeof window !== 'undefined' ? window.MicrosecondLogger : null };
