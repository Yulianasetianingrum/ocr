 ...
 */
if (typeof window !== 'undefined' && !window.ScreenCaptureEngine) {
  /**
 * Real-Time Continuous Screen Capture Engine
...
class ScreenCaptureEngine {
  ...
  window.ScreenCaptureEngine = ScreenCaptureEngine;
}
if (typeof module !== 'undefined') module.exports = { ScreenCaptureEngine: typeof window !== 'undefined' ? window.ScreenCaptureEngine : null };
